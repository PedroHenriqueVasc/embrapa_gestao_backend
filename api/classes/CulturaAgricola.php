...
class CulturaAgricola{
    ...
    public function adicionarCultura(){
        ...
        $query = "INSERT INTO cultura_agricola (cultura, area, ciclo, id_propriedade, id_usuario, data_cadastro, fim_ciclo, vida_util) 
        VALUES (:cultura, :area, :ciclo, :id_propriedade, :id_usuario, :data_cadastro, :fim_ciclo, :vida_util)";
        ...
        try{
            ...
            $result = $stmt->execute();
            return array('status' => 'Success', 'value' => 'Cultura Agrícola cadastrada com sucesso!');
    ...
    public function finalizar(){
        ...
        $query = "SELECT cultura, area, ciclo, fim_ciclo, vida_util  FROM cultura_agricola WHERE id_usuario = $info->id";
